...
/* package sentence-analyzer-0.1.0.0 */
#ifndef VERSION_sentence_analyzer
#define VERSION_sentence_analyzer "0.1.0.0"
#endif /* VERSION_sentence_analyzer */
#ifndef MIN_VERSION_sentence_analyzer
#define MIN_VERSION_sentence_analyzer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_sentence_analyzer */
...
#define CURRENT_COMPONENT_ID "sentence-analyzer-0.1.0.0-inplace-sa"
